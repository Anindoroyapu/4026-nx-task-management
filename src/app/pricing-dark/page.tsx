      ...
      <div className="relative overflow-hidden pricing-page">
        ...
        <nav>
          <div className="main-nav container-wide">
            <img className="block max-w-full w-[125px] h-[34px] logo" src="/assets/imgTaxky.svg" alt="Taxky" />
            <div className="flex items-center gap-3 nav-right">
              <ul>
                <li><a href="/dark">Home Page</a></li>
                <li><a href="/features-dark">Features</a></li>
                <li className="active"><a href="/pricing-dark">Pricing</a></li>
                <li><a href="/about-dark">Know Us</a></li>
                <li><a href="/contact-dark">Contact</a></li>
              </ul>
              <button className="mode-toggle" type="button" onClick={() => { window.location.href = "/pricing" }}>
        ...
        <div className="mobile-header w3-white">
          ...
          <div className="flex items-center gap-[10px]" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <button className="mode-toggle" type="button" onClick={() => { window.location.href = "/" }}>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.5833 10.3987C15.5836 10.9324 14.4417 11.2351 13.2292 11.2351C9.29092 11.2351 6.09827 8.04245 6.09827 4.10407C6.09827 2.89158 6.40087 1.74976 6.93469 0.750031C3.38971 1.58085 0.75 4.76264 0.75 8.56095C0.75 12.9916 4.34175 16.5834 8.77242 16.5834C12.5707 16.5834 15.7525 13.9437 16.5833 10.3987Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
        ...
        <section className="pt-[112px] cta-footer">
          ...
          <footer className="bg-[#141414] text-white pt-[306px] pb-10 bg-[#0a0b0f]">
            <div className="grid gap-12 mx-auto wrap-1480 footer-grid">
              <div>
                ...
                <div className="mt-6 flex gap-1 p-1 rounded-full w-fit bg-[rgba(255,255,255,0.12)] socials"><img className="block max-w-full w-10 h-10 p-[7px] rounded-[100px] bg-[#141414] bg-[#0f1117]" src="/assets/imgGroup1.svg" alt="" /><img className="block max-w-full w-10 h-10 p-[7px] rounded-[100px] bg-[#141414] bg-[#0f1117]" src="/assets/imgFamiconsLogoBehance.svg" alt="" /><img className="block max-w-full w-10 h-10 p-[7px] rounded-[100px] bg-[#141414] bg-[#0f1117]" src="/assets/imgEntypoSocialLinkedinWithCircle.svg" alt="" /><img className="block max-w-full w-10 h-10 p-[7px] rounded-[100px] bg-[#141414] bg-[#0f1117]" src="/assets/imgAntDesignInstagramFilled.svg" alt="" /><img className="block max-w-full w-10 h-10 p-[7px] rounded-[100px] bg-[#141414] bg-[#0f1117]" src="/assets/imgFormkitTwitter.svg" alt="" /></div>
              </div>
              <div>
