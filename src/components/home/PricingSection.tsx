    ...
    >
      <div className="container">
        <div className="section-title centered">
          <h2>
            Smart Pricing Intelligence with Built-In <span>ROI Calculator</span>
          </h2>
          <p>
            Analyze pricing strategies and instantly measure the real return on your investment.
          </p>
        </div>
        <div className="billing-toggle">
          <button type="button" className={!isAnnual ? "active" : ""} onClick={() => setMode("monthly")}>
            Monthly
          </button>
          <button type="button" className={isAnnual ? "active" : ""} onClick={() => setMode("annual")}>
            Annual <span>-20%</span>
          </button>
        </div>
