...
export function ModeToggleIconDark() {
  return (
...
export function ModeToggleImgDark() {
...
export function ModeToggleSvgDark() {
  const path = usePathname();

  return (
    <button className="mode-toggle" type="button" onClick={() => { window.location.href = getToggleTarget(path); }} aria-label="Toggle light mode">
      <ModeToggleIconDark />
    </button>
  );
}
