...
export default function DarkMessageForm() {
  ...
  return (
    <>
      <div className="message-card panel" data-animate>
        <h2>&bull; Send us a <span>Message.</span></h2>
        <form
          className="form-box"
          ref={formRef}
          action="https://formsubmit.co/info@tasktemplate.com"
          method="post"
        ...
        >
          ...
          <input type="hidden" name="_next" value="contact-dark.html" />
