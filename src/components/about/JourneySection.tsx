...
const vectors = [
  { cls: "v v1", src: "/assets/imgVector1.svg" },
  { cls: "v v2", src: "/assets/imgVector2.svg" },
  { cls: "v v3", src: "/assets/imgVector3.svg" },
  { cls: "v v4", src: "/assets/imgVector3.svg" },
  { cls: "v v5", src: "/assets/imgVector4.svg" },
  { cls: "v v6", src: "/assets/imgVector4.svg" },
  { cls: "v v7", src: "/assets/imgVector5.svg" },
];
    ...
    <section className="journey">
      <div className="container-1480">
        ...
        <div className="timeline-shell">
          ...
          {vectors.map((v) => (
            <img key={v.cls} className={v.cls} src={v.src} alt="" />
          ))}
        </div>
      </div>
    </section>
